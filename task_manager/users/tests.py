...
class UserCrudTestCase(TestCase):
    ...
    def test_create_user(self):
        ...
        response = self.client.post(
            reverse_lazy("user_create"), self.test_users["new"], follow=True
        )
        self.assertContains(
        ...
        self.assertContains(
            response, _("A user with that username already exists."), status_code=200
        )
    ...
    def test_update_another_user(self):
        ...
        self.assertContains(
            response, _("You have no rights to change another user."), status_code=200
        )
    ...
    def test_delete_another_user(self):
        ...
        self.assertContains(
            response, _("You have no rights to delete another user."), status_code=200
        )
